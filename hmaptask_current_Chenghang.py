...
Added several lines for continous reward during fixation. Prefer at interval of 400ms.
---Chenghang, 3/6/25.
...
def _RunTrial(app, P):
	...
	try:
		...
		#Added 3/6/25 for continuous reward:   -----Chenghang
