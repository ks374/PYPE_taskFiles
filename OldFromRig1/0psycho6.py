...
##            }
    ...
    def createParamTable(self,app):         #The parameters for this class
		...
		("Reference_Mode", 0, is_int, "1 Nonmatch stims selected randomly from list below. 2 Nonmatch stim selected from 51 shapes"),
